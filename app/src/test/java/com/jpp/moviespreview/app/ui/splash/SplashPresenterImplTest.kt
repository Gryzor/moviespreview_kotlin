...
//        verifyZeroInteractions(moviesConfigurationUseCase, moviesGenresUseCase)
//    }
//
//    @Test
...
//
//        // -- verify
//        verify(moviesConfigurationUseCase).execute()
//        verify(moviesGenresUseCase).execute()
//    }
//
//    @Test
...
//        `when`(moviesConfigurationUseCase.execute()).thenReturn(movieConfigRetrieved)
//        val genreList = ArrayList<Genre>()
//        genreList.add(Genre(12, "Random"))
//        `when`(moviesGenresUseCase.execute()).thenReturn(genreList)
//
//        // -- execute
//        subject.linkView(splashView)
//
